      ...
      drawer: Drawer(
        ...
        children:<Widget> [
          ...
          color: Colors.blueAccent,
           ...
           child: Text("Hello  ${user.displayName}",style: TextStyle(fontSize: 30,color: Colors.white,),textAlign: TextAlign.left,),
          ),
          ListTile(
            ...
            : Column(
                children: <Widget>[
                  ...
                  Container(
                    height: 300,
                    child: Image(
                      image: NetworkImage("https://wallpaperaccess.com/full/1295876.jpg"),
                      fit: BoxFit.contain,
                    ),
                  ),
                  SizedBox(height: 50,),
                  Container(
                        child: Text(
                          "Hello ${user.displayName}, your email-id is ${user.email}",
                          style:
                              TextStyle(fontSize: 25.0, fontWeight: FontWeight.bold,color: Colors.white70),
                        ),
                      ),
